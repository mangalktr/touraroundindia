...
class Admin_ExploreController extends Zend_Controller_Action
{
    ...
    */
    public function indexAction()
    {
        ...
        $resulsetold = $crud->getCount( $this->tablefootermnage,['status' =>1 , 'columnType' =>'explore'],'id');  
        $crud->searchArr = $searchArr;
        $resultset = $crud->rv_select_static( $this->tablefootermnage,['*'],['columnType' =>'explore' ],['id'=> 'DESC']);  
    ...
    public function editexploreAction(){
        //Check admin logedin or not
        $this->checklogin();
        $crud = new Admin_Model_CRUD();
        $form = new Admin_Form_Editexplore();
        $pId = (int)$this->getRequest()->getParam("id");
        $form->setMethod("POST");
        $form->setAction("admin/explore/editexplore/id/".$pId);
        $form->setName("edit_explore_page");
...
//        echo "<pre>";print_r($editdata);die;
    ...
    public function addexploreAction(){
...
// echo "<pre>";print_r($savePageData);die;
    ...
    public function deleteexploreAction(){
        $this->checklogin();
        $crud = new Admin_Model_CRUD();
        $tId = (int)$this->getRequest()->getParam("id");
        if($tId){
