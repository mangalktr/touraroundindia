...
//            echo '<pre>'; print_r($temp['tourType']); die('here');
            ...
            $priceJsonViewFile  = $this->getCategoryAndPriceArrayJSON( $temp['tourType'] , 'B2C' , $PackageType , $PackageSubType );
...
//echo $categoryDetails['MPType']; die;
            
//            $priceArrJson = $this->getPriceArrayFullyDynamicJSON( $temp['tourType'] , $market , $PackageType , $PackageSubType );

//            echo '<pre>'; print_r( $priceArray ); die('here');
...
//            echo '<pre>'; print_r($tourTypeRadio); die('here');
    ...
    public function getPackageCardDetails( array $relatedPackages )
    {
        ...
        if(isset($relatedPackages)) {
          ...
          foreach ($relatedPackages as $key => $value) {
            ...
            $categoryDetails = $this->getCategoryAndPriceArray( $LongJsonInfo['package']['TourTypes']['MarketType'] , 'B2C' , $value['PackageType'] , $value['PackageSubType'] ); // get default category
...
//            var_dump($issend);
    ...
    public function mailSentByElastice($emailData,$arrEmailStatistics = array()) {
        ...
        try {
            $emailSenderKey = trim('c4bf5bce-8244-4624-be34-ac919e26cae4');
            $post = array(
