 ...
 */
class Flexsin_FacebookApiException extends Exception {
...
class Flexsin_Facebook {
     ...
     * @throws Flexsin_FacebookApiException
     */
    protected function _restserver($params) {
        ...
        if (is_array($result) && isset($result['error_code'])) {
            throw new Flexsin_FacebookApiException($result);
        }
        return $result;
    }
    ...
    protected function _graph($path, $method='GET', $params=array()) {
        ...
        if (is_array($result) && isset($result['error'])) {
            $e = new Flexsin_FacebookApiException($result);
            switch ($e->getType()) {
                // OAuth 2.0 Draft 00 style
                case 'OAuthException':
                // OAuth 2.0 Draft 10 style
    ...
    protected function makeRequest($url, $params, $ch=null) {
        ...
        $result = curl_exec($ch);
        if ($result === false) {
            $e = new Flexsin_FacebookApiException(array(
    ...
    public function getUserInfo() {
        ...
        curl_close($ch);
        return $userfacebook = json_decode($xml_resp);
